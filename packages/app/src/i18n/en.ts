export const dict = {
  ...
  "model.custom.add.title": "Add custom model",
  "model.custom.edit.title": "Edit custom model",
  "model.custom.section.title": "Custom models",
  "model.custom.section.description": "Models you've added manually.",
  "model.custom.add.button": "Add custom model",
  "model.custom.edit.button": "Edit",
  "model.custom.delete.button": "Delete",
  "model.custom.delete.confirm": 'Delete custom model "{{name}}"?',
  "model.custom.tag": "Custom",

  "model.custom.field.id.label": "Model ID",
  "model.custom.field.id.placeholder": "e.g., gpt-5",
  "model.custom.field.id.description": "The model identifier used by the provider",
  "model.custom.field.provider.label": "Provider",
  "model.custom.field.name.label": "Display name",
  "model.custom.field.name.placeholder": "e.g., GPT-5 (Preview)",
  "model.custom.field.contextWindow.label": "Context window",
  "model.custom.field.contextWindow.placeholder": "128000",
  "model.custom.field.contextWindow.description": "Maximum tokens in context",
  "model.custom.field.cost.label": "Cost per 1M tokens (USD)",
  "model.custom.field.inputCost.label": "Input",
  "model.custom.field.inputCost.placeholder": "2.00",
  "model.custom.field.outputCost.label": "Output",
  "model.custom.field.outputCost.placeholder": "10.00",
  "model.custom.field.cacheCost.label": "Cache cost per 1M tokens (optional)",
  "model.custom.field.cacheReadCost.label": "Read",
  "model.custom.field.cacheReadCost.placeholder": "0.50",
  "model.custom.field.cacheWriteCost.label": "Write",
  "model.custom.field.cacheWriteCost.placeholder": "1.00",
  "model.custom.field.maxOutput.label": "Max output tokens (optional)",
  "model.custom.field.maxOutput.placeholder": "4096",
  "model.custom.field.maxOutput.description": "Maximum tokens in response",

  "model.custom.error.id.required": "Model ID is required",
  "model.custom.error.provider.required": "Provider is required",
  "model.custom.error.name.required": "Display name is required",
  "model.custom.error.contextWindow.required": "Context window must be greater than 0",
  "model.custom.error.cost.negative": "Cost cannot be negative",
  "model.custom.error.duplicate": "A custom model with this ID already exists for this provider",
